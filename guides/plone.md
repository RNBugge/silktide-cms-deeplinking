...
Use this guide to enable Silktide’s **Edit** button to deep-link users from a page in Silktide to the correct editor screen in **Plone**.

## How editing works in this CMS
Plone supports action URLs like `/edit` on the same content URL. Logged-in editors can jump into edit mode directly.

## Recommended approach and why
Plone supports action URLs like /edit on the same content URL, so editorUrl can be derived from the public URL.

### URL transform rule
**Example:** Public: https://example.com/about → Editor: https://example.com/about/edit
...
No internal IDs needed if `/edit` is enabled.
