# ProcessWire → Silktide deep-link integration template

**Silktide support:** Custom (customer-built)  
**Recommended deep-link approach:** Meta tag (page outputs editor URL)

Use this guide to enable Silktide’s **Edit** button to deep-link users from a page in Silktide to the correct editor screen in **ProcessWire**.

## How editing works in this CMS
ProcessWire edits pages in the admin interface with page IDs. Public URLs are path-based.

## Recommended approach and why
Admin edit URLs require the page ID; public URL is path-based.
...
Use the current page ID and admin base URL.

### Example editor URL patterns
- `https://{SITE}/admin/page/edit/?id={PAGE_ID}`
