# Crownpeak → Silktide deep-link integration template

**Silktide support:** Custom (customer-built)  
**Recommended deep-link approach:** Meta tag (page outputs editor URL)

Use this guide to enable Silktide’s **Edit** button to deep-link users from a page in Silktide to the correct editor screen in **Crownpeak**.

## How editing works in this CMS
Crownpeak has multiple products and authoring UIs; editing links are usually ID/workflow based and not derivable from public URLs alone.

## Recommended approach and why
Authoring UI uses internal asset IDs; public URL mapping varies.
...
Use the asset/page identifier from your rendering/publishing layer to build an authoring link.

### Example editor URL patterns
- `Crownpeak deep links vary by product and tenant; typically ID-based.`
