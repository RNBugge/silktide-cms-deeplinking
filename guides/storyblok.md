# Storyblok → Silktide deep-link integration template

**Silktide support:** Custom (customer-built)  
**Recommended deep-link approach:** Meta tag (page outputs editor URL)

Use this guide to enable Silktide’s **Edit** button to deep-link users from a page in Silktide to the correct editor screen in **Storyblok**.

## How editing works in this CMS
Storyblok is headless and uses internal story IDs/UUIDs for editing. Public URLs are not guaranteed to expose these IDs.

## Recommended approach and why
Headless: emit meta tag with story ID and space ID, pointing into the Visual Editor.
...
Use the Story ID/UUID at render time and your Storyblok space.

### Example editor URL patterns
- `https://app.storyblok.com/#!/me/spaces/{SPACE_ID}/stories/0/0/{STORY_ID}`
