# DatoCMS → Silktide deep-link integration template

**Silktide support:** Custom (customer-built)  
**Recommended deep-link approach:** Meta tag (page outputs editor URL)

Use this guide to enable Silktide’s **Edit** button to deep-link users from a page in Silktide to the correct editor screen in **DatoCMS**.

## How editing works in this CMS
DatoCMS editor links require project and item IDs. Public URLs are custom.

## Recommended approach and why
Editor URLs are model/item-ID based and not derivable from public slugs.
...
Use the project ID and item ID from your rendering layer.

### Example editor URL patterns
- `https://dashboard.datocms.com/projects/{PROJECT_ID}/content/items/{ITEM_ID}`
