...
Use this guide to enable Silktide’s **Edit** button to deep-link users from a page in Silktide to the correct editor screen in **Statamic**.

## How editing works in this CMS
Statamic control panel editing links depend on collection/entry identifiers. Public URLs are route-based and may not include IDs.
...
Use the entry ID/slug and collection handle to build the CP edit URL.

### Example editor URL patterns
- `https://{SITE}/cp/collections/{COLLECTION}/entries/{ENTRY_ID}`
