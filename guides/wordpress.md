# WordPress → Silktide deep-link integration template
...
Use this guide to enable Silktide’s **Edit** button to deep-link users from a page in Silktide to the correct editor screen in **WordPress**.

## How editing works in this CMS
Silktide provides a built-in integration for deep-linking (Edit button).
