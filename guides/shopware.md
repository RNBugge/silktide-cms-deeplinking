# Shopware → Silktide deep-link integration template

**Silktide support:** Custom (customer-built)  
**Recommended deep-link approach:** Meta tag (page outputs editor URL)

Use this guide to enable Silktide’s **Edit** button to deep-link users from a page in Silktide to the correct editor screen in **Shopware**.

## How editing works in this CMS
Shopware admin editing uses UUIDs/IDs for entities and happens in the admin interface. Public storefront URLs are SEO/slug based.

## Recommended approach and why
Admin edit URLs usually include entity IDs; public slugs aren’t enough.
...
Use entity UUID/ID from rendering context to build an admin deep link (Shopware Admin supports entity-based routing).

### Example editor URL patterns
- `Shopware Admin deep links vary by version; typically include entity type + UUID.`
