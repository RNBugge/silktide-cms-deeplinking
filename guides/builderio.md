# Builder.io → Silktide deep-link integration template

**Silktide support:** Custom (customer-built)  
**Recommended deep-link approach:** Meta tag (page outputs editor URL)

Use this guide to enable Silktide’s **Edit** button to deep-link users from a page in Silktide to the correct editor screen in **Builder.io**.

## How editing works in this CMS
Builder.io editor links are content ID based. Public URLs are custom.

## Recommended approach and why
Editing happens inside Builder with content IDs/spaces; public URLs are typically mapped via model/URL fields.
...
Use the Builder content ID/model from your rendering layer.

### Example editor URL patterns
- `https://builder.io/content/{MODEL}/{CONTENT_ID}`
