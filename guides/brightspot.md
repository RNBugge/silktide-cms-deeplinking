# Brightspot → Silktide deep-link integration template

**Silktide support:** Custom (customer-built)  
**Recommended deep-link approach:** Meta tag (page outputs editor URL)

Use this guide to enable Silktide’s **Edit** button to deep-link users from a page in Silktide to the correct editor screen in **Brightspot**.

## How editing works in this CMS
Brightspot editing occurs in its authoring UI, typically referencing content IDs and site configuration. Public URLs generally don’t contain stable internal IDs.

## Recommended approach and why
Authoring is ID-based and implementation-specific; public URLs don’t reliably encode item IDs.
...
Use Brightspot content ID/object identifier in the rendering layer to generate an authoring URL.

### Example editor URL patterns
- `Brightspot authoring deep links are installation-specific; typically include content ID.`
