...
Use this guide to enable Silktide’s **Edit** button to deep-link users from a page in Silktide to the correct editor screen in **Squarespace**.

## How editing works in this CMS
Squarespace editor navigation is primarily within the Squarespace admin UI and does not provide a universal per-page editor URL derived from the public URL.
