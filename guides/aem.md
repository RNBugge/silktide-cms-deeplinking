...
**Silktide guide:** https://help.silktide.com/en/articles/8020840-how-to-integrate-silktide-with-adobe-experience-manager-aem

Use this guide to enable Silktide’s **Edit** button to deep-link users from a page in Silktide to the correct editor screen in **Adobe Experience Manager (AEM)**.
