# WooCommerce → Silktide deep-link integration template

**Silktide support:** Built-in (Silktide)  
**Recommended deep-link approach:** Built-in


**Silktide guide:** https://help.silktide.com/en/articles/8117667-how-to-integrate-silktide-with-wordpress

Use this guide to enable Silktide’s **Edit** button to deep-link users from a page in Silktide to the correct editor screen in **WooCommerce**.

## How editing works in this CMS
WooCommerce runs on WordPress; products and pages are edited through the standard WordPress admin. If you already use Silktide’s WordPress integration, that covers WooCommerce too.
