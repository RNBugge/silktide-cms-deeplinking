# Kontent.ai → Silktide deep-link integration template

**Silktide support:** Custom (customer-built)  
**Recommended deep-link approach:** Meta tag (page outputs editor URL)

Use this guide to enable Silktide’s **Edit** button to deep-link users from a page in Silktide to the correct editor screen in **Kontent.ai**.

## How editing works in this CMS
Kontent.ai editor links require project/environment and content item IDs. Public URLs are custom.

## Recommended approach and why
Editor URLs use internal item IDs/codenames; public URL mapping is custom.
...
Use content item ID and project identifiers.

### Example editor URL patterns
- `https://app.kontent.ai/{PROJECT_ID}/content-inventory/{ITEM_ID}`
